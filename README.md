...
A web-based color palette generator designed to bridge the gap between visual appeal and accessibility standards.
...
-   **Real-time Color Generation:** Uses the **OKLCH** color space for perceptually consistent lightness/chroma across different color hues.
